...
export default function Home(){
 ...
 <section id="about" className="process dynamic-section"><div className=""><small>OUR PROCESS</small><h3>SIMPLE. PROVEN. BUILT FOR TRADIES.</h3></div><div className="">{[["▤","1. ENQUIRY","Tell us about your trade and where you work."],["▧","2. PLAN","We show you the best strategy for your area."],["➤","3. LAUNCH","We set everything up and get it live."],["▥","4. MORE JOBS","You get consistent, high-quality enquiries."]].map(([i,n,d])=><article key={n}><b>{i}</b><h4>{n}</h4><p>{d}</p></article>)}</div></section>
 <section className="finalCta dynamic-section"><div className="roof"></div><div className=""><small>READY TO GET STARTED?</small><h3>MORE JOBS<br/>ARE OUT THERE.</h3><p>Let’s get you in front of the right customers<br/>and turn more enquiries into real work.</p><a className="pinkBtn" href="#contact">GET MORE JOBS&nbsp; →</a></div></section>
 </main>
}